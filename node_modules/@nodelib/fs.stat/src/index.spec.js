...
describe('Package', () => {
    ...
    describe('.stat', () => {
        it('should work without options or settings', (done) => {
            (0, _1.stat)('fixtures/b', (error, stats) => {
        ...
        it('should work with options', (done) => {
            (0, _1.stat)('fixtures/b', { markSymbolicLink: true }, (error, stats) => {
                assert.strictEqual(error, null);
        ...
        it('should work with settings', (done) => {
            ...
            (0, _1.stat)('fixtures/b', settings, (error, stats) => {
                assert.strictEqual(error, null);
                assert.strictEqual(stats.isSymbolicLink(), true);
                done();
            });
    ...
    describe('.statSync', () => {
        it('should work without options or settings', () => {
            const actual = (0, _1.statSync)('fixtures/b');
            assert.ok(actual);
        });
        it('should work with options', () => {
            const actual = (0, _1.statSync)('fixtures/b', { markSymbolicLink: true });
            assert.strictEqual(actual.isSymbolicLink(), true);
        });
        it('should work with settings', () => {
            const settings = new _1.Settings({ markSymbolicLink: true });
            const actual = (0, _1.statSync)('fixtures/b', settings);
            assert.strictEqual(actual.isSymbolicLink(), true);
        });
    });
});
